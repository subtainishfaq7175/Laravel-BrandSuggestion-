        ...
        <div class="panel panel-default credit-card-box">
            <div class="panel-heading display-table" >
                <div class="row display-tr" >
                    <h3 class="panel-title display-td" >Subscription Form</h3>
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    {!! Form::open(['url' => route('/postSubscription'), 'data-parsley-validate', 'id' => 'payment-form']) !!}
                    ...
                    <div class="form-group" id="product-group">
                        ...
                        {!! Form::select('plane', ['10' => '20 request ($10)', '20' => '50 request ($20)', '35' => '100 request ($35)'], 'Book', [
                            'class'                       => 'form-control',
                            'required'                    => 'required',
